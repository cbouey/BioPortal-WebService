...
SKIP: {
    ...
    describe 'A bioportal webservice downloader' => sub {
        ...
        it 'should fetch a downloader object with a non-empty file'
            => sub {
        ...
        it 'should parse the downloaded obo file' => sub {
            ...
            my $obo  = OBO::Parser::OBOParser->new->work($download->filename);
            is( $obo->has_term( $obo->get_term_by_name('author statement') ), 1 );
        };
    };
